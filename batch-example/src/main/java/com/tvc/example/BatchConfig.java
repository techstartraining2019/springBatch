...
public class BatchConfig 
{
    ...
    public FlatFileItemReader<Employee> reader() 
    {
        ...
        reader.setResource(new FileSystemResource("C:\\demo-projects\\spring-batch\\batch-example\\src\\main\\resources\\input\\inputData.csv"));
